...
var _internalProtoAccess = __webpack_require__(6);
...
var _dog = __webpack_require__(37);
...
var _chartHandlebars = __webpack_require__(12);
...
var Cat = function () {
  function Cat(context, options) {
    ...
    (0, _chartHandlebars.createHandlebars)(this._context, this.chartData);
...
var _handlebars = __webpack_require__(13);

var Handlebars = _interopRequireWildcard(_handlebars);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var chartTypes = ['horizontal-bar'];

function createHandlebars(context, chartData) {

  var validChartType = chartTypes.indexOf(chartData.type) > -1;
  ...
  var templateScript = Handlebars.compile(chartHTML);

  var html = templateScript(chartData);

  context.nativeElement.innerHTML = validChartType ? html : '<p>Chart type is not supported</p>';

  setTimeout(function () {
    document.querySelectorAll('.grid-line').forEach(function (gridLine, index) {
      var offsetWidth = gridLine['offsetWidth'];
...
var _handlebarsCompilerVisitor = __webpack_require__(9);
